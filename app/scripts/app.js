...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var svgMap = function () {
    ...
    _createClass(svgMap, [{
      key: "addSvg",
      value: function addSvg(svg) {
        this.svg = svg;
      }
    }, {
      key: "addStations",
      value: function addStations(json) {
        this.stations = json;
      }
    }, {
      key: "findStation",
      ...
      value: function findLabel(id) {
        ...
        console.log(keyStations[indexStation], '#scheme-layer-stations');
        console.log(this.stations[keyStations[indexStation]]['labelId'], '#scheme-layer-labels');
      }
    }, {
      key: "findlink",
